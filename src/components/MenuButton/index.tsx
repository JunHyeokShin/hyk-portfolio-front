...
export default function MenuButton() {
  ...
  useGSAP(() => {
    ...
    menuToggleAnimation.current.to("#menu-button-icon", { top: "-1rem", duration: 0.2, ease: "power2.out" });
    menuToggleAnimation.current.to("#menu-button-icon-second", { top: 0, duration: 0.2, ease: "power2.out" }, 0);
    menuToggleAnimation.current.to("#home-button", { visibility: "inherit", y: "-4.125rem", duration: 0.2, ease: "back.out" }, 0);
    menuToggleAnimation.current.to("#blog-button", { visibility: "inherit", y: "-2.125rem", duration: 0.1, ease: "back.out" }, 0);
  });
